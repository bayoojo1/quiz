...
if($count > 0){
  ...
  foreach($stmt->fetchAll(PDO::FETCH_ASSOC) as $row) {
    ...
    $resultpage .= '<button type="button" id="editans" class="btn btn-success btn-sm" onclick="editsport(this);">Edit Answer</button>';
    $resultpage .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    $resultpage .= '<button type="button" id="saveans" style="visibility:hidden" class="btn btn-success btn-sm" onclick="savesport(this);">Save</button>';
    $resultpage .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    $resultpage .= '<button type="button" id="deleteans" class="btn btn-success btn-sm" onclick="delete_sport_question(this);">Delete Question</button>';
    $resultpage .= '</div>';
    $resultpage .= '</div>';
  }
  $resultpage .= '</div>';
