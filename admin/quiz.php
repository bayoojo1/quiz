  ...
  <div class="container text-center" style="margin-top:50px;">
      <div class="col-sm-8 col-sm-offset-2">
        <div class="panel panel-default optionals">
          <div class="panel-heading opt-heading"><h3>General Knowledge Question</h3></div>
          <div class="panel-body pbody" style="height:200px; margin-top:60px;">
            <form id="uploadquestion">
              <div style="margin-left:240px;"><input type="file" name="audio" id="audio" required></div><br>
              <input type="text" name="answer" id="answer" placeholder="Enter answer" required>
              <button type="button" class="btn btn-success btn-xs" id="uploadbtn" style="background-color:black; color:white;">Upload</button>
            </form>
              <div id="uploadstatus"></div>
          </div>
          <div class="panel-footer pfooter" style="background-color:black;">
            <a style="color:white;" href="question.php?u=<?php echo $log_username ?>">Check general Knowledge questions</a>
          </div>
        </div>
